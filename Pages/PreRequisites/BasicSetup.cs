...
namespace WiseUltimaTests.Pages.PreRequisites
{
    public class BasicSetup
    {
        ...
        {
            await _page.GetByPlaceholder("Enter your email")
                       .FillAsync(username);

            await _page.GetByPlaceholder("Enter your password")
                       .FillAsync(password);
        ...
        {
            await _page.GetByPlaceholder("Enter your Name")
                    .FillAsync(name);
            await _page.GetByPlaceholder("Enter your email")
                    .FillAsync(email);
            ...
            if (!isOrganizationEmpty)
        {
            ...
            await _page.GetByPlaceholder("Confirm your password")
